...
class find_ability:
    ...
    def find(self):
        template = cv.imread(f'{self.find_images_path}template.png', 0)
        top_left, bottom_right = self.find_by_img(template)
        return top_left + bottom_right
    

    def find_input(self):
        template = cv.imread(f'{self.find_images_path}input.png', 0)
    ...
    def find_Q(self):
        template = cv.imread(f'{self.find_images_path}Q.png', 0)
    ...
    def find_W(self):
        template = cv.imread(f'{self.find_images_path}W.png', 0)
    ...
    def find_E(self):
        template = cv.imread(f'{self.find_images_path}E.png', 0)
    ...
    def find_R(self):
        template = cv.imread(f'{self.find_images_path}R.png', 0)
    ...
    def find_P(self):
        template = cv.imread(f'{self.find_images_path}P.png', 0)
    ...
    def find_play(self):
        template = cv.imread(f'{self.find_images_path}play.png', 0)
    ...
    def find_spell_name(self):
        template = cv.imread(f'{self.find_images_path}spell_name.png', 0)
    ...
    def find_submit(self):
        template = cv.imread(f'{self.find_images_path}submit.png', 0)
